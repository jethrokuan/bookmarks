...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = {
	  components: {
	    ...
	    Tags: _Tags2.default,
	    'pulse-spinner': _PulseLoader2.default
	  },
	  data: function data() {
	    return {
	      repo: '',
	  ...
	  methods: {
	    fetchData: function fetchData() {
	      ...
	      _superagent2.default.get('/static/config.json').set('Accept', 'application/json').end(function (err1, configRes) {
	        if (err1) {
	          return;
	        }
	        ...
	        _superagent2.default.get(url).set('Accept', 'application/json').end(function (err2, ghData) {
	          ...
	          var data = JSON.parse(ghData.text);
	          var labelSet = [];
	          var labels = [];
	          for (var i in data) {
	          ...
	          _this.$set('labels', labelSet);
	          _this.$set('bookmarks', data);
	        });
	      });
	    }
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = {
	  ...
	  computed: {
	    ...
	    selectedBookmarks: function selectedBookmarks() {
	      var _this = this;
	
	      var bookmarks = [];
	      for (var i in this.bookmarks) {
	        var labels = [];
	        for (var j in this.bookmarks[i].labels) {
	          labels.push(this.bookmarks[i].labels[j].name);
	        }
	
	        var _loop = function _loop(k) {
	          var result = labels.some(function (l) {
	            return l === _this.selectedLabels[k];
	          });
	          if (result) {
	            bookmarks.push(_this.bookmarks[i]);
	            return 'break';
	          }
	        };
	
	        for (var k in this.selectedLabels) {
	          var _ret = _loop(k);
	    ...
	    haveBookmarks: function haveBookmarks() {
...
/***/ function(module, exports) {
	...
	exports.default = {
	  props: ['color', 'title', 'selected'],
	  methods: {
	    fontcolor: function fontcolor(hex) {
	      var h = '0x' + hex;
	      var r = h >> 16;
	      var g = (h & 0x00FF00) >> 8;
	      var b = h & 0x0000FF;
	      var color = r + g + b > 385.5 ? '#222' : '#FFF';
	      return color;
	    },
...
/***/ function(module, exports) {
	...
	module.exports = "\n<span @click=\"addToList()\" :class=\"{'selected' : !selected}\" :style=\"{backgroundColor:'#' + color, color: fontcolor(color)}\" _v-3e10694e=\"\">{{ title }}</span>\n";
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	    __vue_script__.__esModule &&
	    Object.keys(__vue_script__).length > 1) {
	  console.warn("[vue-loader] src/components/Bookmark.vue: named exports in *.vue files are ignored.")}
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	    __vue_script__.__esModule &&
	    Object.keys(__vue_script__).length > 1) {
	  console.warn("[vue-loader] src/components/Bookmarks.vue: named exports in *.vue files are ignored.")}
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	    __vue_script__.__esModule &&
	    Object.keys(__vue_script__).length > 1) {
	  console.warn("[vue-loader] src/components/TagPill.vue: named exports in *.vue files are ignored.")}
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	    __vue_script__.__esModule &&
	    Object.keys(__vue_script__).length > 1) {
	  console.warn("[vue-loader] src/components/Tags.vue: named exports in *.vue files are ignored.")}
